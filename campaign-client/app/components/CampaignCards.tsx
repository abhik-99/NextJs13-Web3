  ...
  return (
    <Link href={link} className="flex items-center justify-center">
      <div className="h-48 w-80 relative group">
        ...
        <div className="min-h-full min-w-full relative px-7 py-6 bg-gray-900 border border-gray-400 ring-1 ring-gray-900/5 rounded-lg leading-none flex flex-col items-center justify-center space-x-6">
          {children}
        </div>
      </div>
    </Link>
