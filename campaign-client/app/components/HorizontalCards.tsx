...
const HorizontalCards = ({ img, alt, heading, body, link, reversed }: HorizontalCardsProps) => {
  return (
    <Link
      href={link}
      className="flex flex-col items-center border rounded-lg shadow md:flex-row md: justify-between md:w-2/3 border-gray-500 bg-gray-900 hover:bg-gray-700 m-2"
    >
      {!reversed ? (
        <>
          <img
